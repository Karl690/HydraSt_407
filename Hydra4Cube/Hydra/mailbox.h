...
#define FLASH_1024_CRASH_SECTOR     HYREL_FLASH_Sector_10
#define FLASH_1024_CRASH_ADDR       (FLASH_BASE + (6 * 128 * 1024))
#define FLASH_1024_CRASH_SIZE       (128 * 1024)

#define FLASH_2048_CRASH_SECTOR     HYREL_FLASH_Sector_22
